...
const ChecoutForm = ({data}) => {
    ...
    useEffect(() => {
        ...
        fetch("https://food-products-server.vercel.app/create-payment-intent", {
            method: "POST",
            headers: {
    ...
    const handleSubmit = async (event) => {
        ...
        if (paymentIntent.status === "succeeded") {
            ...
            fetch("  https://food-products-server.vercel.app/payments", {
                method: "POST", // or 'PUT'
                headers: {
                    "Content-Type": "application/json",
                    authorization: `bearer ${localStorage.getItem('accessToken')}`
                ...
                .then(data => {
                    if (data.insertedId) {
                        toast.success('Congreats! your payment completed');
