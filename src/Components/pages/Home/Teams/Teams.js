...
const Teams = () => {
    return (
        <div className='mt-28'>
            ...
            <div className="carousel w-full mt-36">
                <div id="item1" className="carousel-item grid grid-cols-3 w-11/12 gap-5 mx-auto">
                    <div className="card w-96 bg-base-100 shadow-xl h-[500px] border-2 border-green-500 ms-5">
