        ...
        <div className="carousel w-full">
            <div id="slide1" draggable='true' className="carousel-item relative w-full text-justify md:-mt-0 -mt-[1px]">
                ...
                <div className=" absolute flex justify-between transform -translate-y-1/2 left-5 right-5 md:top-1/2 top-1/4">
                    <a href="#slide5" className="btn btn-circle btn-sm md:btn-md text-white bg-amber-500 hover:bg-orange-600">❮</a>
                    <a href="#slide2" className="btn btn-circle btn-sm md:btn-md text-white bg-amber-500 hover:bg-orange-600">❯</a>
                </div>
            </div>
            ...
            <div id="slide2" draggable='true' className="carousel-item relative w-full text-justify lg:mt-12  md:-mt-0 -mt-[1px]">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='md:w-1/2 md:px-7 text-white'>
                ...
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 md:top-1/2 top-1/4">
                    <a href="#slide1" className="btn btn-circle btn-sm md:btn-md text-white bg-amber-500 hover:bg-orange-600">❮</a>
                    <a href="#slide3" className="btn btn-circle btn-sm md:btn-md text-white bg-amber-500 hover:bg-orange-600">❯</a>
                </div>
            </div>
            <div id="slide3" draggable='true' className="carousel-item relative w-full text-justify lg:mt-12 md:-mt-0 -mt-[1px]">
                ...
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 md:top-1/2 top-1/4">
                    <a href="#slide2" className="btn btn-circle btn-sm md:btn-md  text-white bg-amber-500 hover:bg-orange-600">❮</a>
                    <a href="#slide4" className="btn btn-circle btn-sm md:btn-md text-white bg-amber-500 hover:bg-orange-600">❯</a>
                </div>
            </div>
